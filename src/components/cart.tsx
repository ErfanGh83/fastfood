...
export default function Cart(){
    ...
    return(
        <div className='cart-container w-full h-fit rounded-t-3xl p-4 bg-yellow-50 font-mono'>
            ...
            <div>
                <ul className='foods w-full flex flex-col h-fit max-h-[400px] overflow-y-auto'>
                    {inCartFoods.map((food)=>(
                        <li className='food w-4/5 justify-betwee flex flex-row-reverse items-center mx-auto border-b-2 border-b-orange-200 justify-between'>
                            <div className='w-1/3'>
                ...
                <form className='flex flex-row justify-between items-center my-4'>
